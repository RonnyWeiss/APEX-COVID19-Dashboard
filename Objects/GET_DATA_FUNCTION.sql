...
BEGIN
    ...
    IF ( SYSDATE - 1 / 24 ) > VR_LAST_DATE OR P_IN_FORCE = 1 THEN
        ...
        INSERT INTO T_COVID_CASES_INT (
            ...
            ( SELECT
                CASE
                  WHEN COUNTRY = 'Austia' THEN 'Austria'
                  WHEN COUNTRY = 'Libya' AND LONGI = -4 AND LAT = 17 THEN 'Libya (17,-4)'
                  ELSE COUNTRY
                END,
                COUNTRY_SHORT,
                LAT,
            ...
            FROM
                (
                    SELECT
                        ...
                        TO_NUMBER(COL013) AS VALUE_CONFIRMED,
                        TO_NUMBER(COL014) AS VALUE_RECOVERED,
                        TO_NUMBER(COL015) AS VALUE_DEATHS,
                        GREATEST(TO_NUMBER(COL013) - NVL(
                            TO_NUMBER(COL014),
                            0
                        ) - NVL(
                            TO_NUMBER(COL015),
